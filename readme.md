...
[F1-2026-MOD-BN-Technical-Reference.md](F1-2026-MOD-BN-Technical-Reference.md).
...
inherited from MOD2020, a custom font, several graphical adjustments and fixes
...
in [F1-2026-MOD-BN-Technical-Reference.md](F1-2026-MOD-BN-Technical-Reference.md#part-iv-using-tweak-f1py).

## Main files

- `F1-2026-MOD-BN.sna` — the modified game
- `Tweak-F1.py` — season-customisation program
- `F1-2026-MOD-BN-Technical-Reference.md` — technical documentation
